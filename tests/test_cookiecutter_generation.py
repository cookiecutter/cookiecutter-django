...
SUPPORTED_COMBINATIONS = [
    ...
    {"use_docker": "y"},
    {"use_docker": "n"},
    {"database_engine": "postgres", "database_version": "postgres@14.1"},
    {"database_engine": "postgres", "database_version": "postgres@13.5"},
    {"database_engine": "postgres", "database_version": "postgres@12.9"},
    {"database_engine": "postgres", "database_version": "postgres@11.14"},
    {"database_engine": "postgres", "database_version": "postgres@10.9"},
...
UNSUPPORTED_COMBINATIONS = [
    ...
    {"database_engine": "postgres", "database_version": "mysql@5.7"},
    {"database_engine": "mysql", "database_version": "postgres@14.1"},
    {"database_engine": "mysql", "database_version": "postgres@13.5"},
    {"database_engine": "mysql", "database_version": "postgres@12.9"},
    {"database_engine": "mysql", "database_version": "postgres@11.14"},
    {"database_engine": "mysql", "database_version": "postgres@10.19"},
]
